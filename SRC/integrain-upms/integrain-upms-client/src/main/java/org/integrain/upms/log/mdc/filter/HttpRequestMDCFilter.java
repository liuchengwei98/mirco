package org.integrain.upms.log.mdc.filter;
...
import org.integrain.upms.log.mdc.MDCConstants;
...
public class HttpRequestMDCFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        try {
        	//日志链放入MDC域中
        	MDC.put(MDCConstants.REQUEST_AUDIT_UUID.toLowerCase(),hsr.getHeader(MDCConstants.REQUEST_AUDIT_UUID));
           //mdc(hsr);
        } catch (Exception e) {
            //
        }
